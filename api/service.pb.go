...
const file_service_proto_rawDesc = "" +
	"\n" +
	"\rservice.proto\x12\aservice\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\x03url\x18\x01 \x03(\v2\x10.service.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\xe0\x01\n" +
	"\x10ShortenerService\x12E\n" +
	"\n" +
	"ShortenURL\x12\x1a.service.URLShortenRequest\x1a\x1b.service.URLShortenResponse\x12B\n" +
	"\tExpandURL\x12\x19.service.URLExpandRequest\x1a\x1a.service.URLExpandResponse\x12A\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x19.service.UserURLsResponseB\x0eZ\fdemo/serviceb\beditionsp\xe8\a"
...
var file_service_proto_goTypes = []any{
	...
	(*URLExpandRequest)(nil),   // 2: service.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: service.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: service.UserURLsResponse
	(*URLData)(nil),            // 5: service.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_service_proto_depIdxs = []int32{
	5, // 0: service.UserURLsResponse.url:type_name -> service.URLData
	0, // 1: service.ShortenerService.ShortenURL:input_type -> service.URLShortenRequest
	2, // 2: service.ShortenerService.ExpandURL:input_type -> service.URLExpandRequest
	6, // 3: service.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: service.ShortenerService.ShortenURL:output_type -> service.URLShortenResponse
	3, // 5: service.ShortenerService.ExpandURL:output_type -> service.URLExpandResponse
	4, // 6: service.ShortenerService.ListUserURLs:output_type -> service.UserURLsResponse
